package sptech.school.projeto_06_service.entity;
...
public class Agendamento {
    ...
    public @NotBlank @Size(min = 3, max = 100) String getLocal() {
        return local;
    }

    public void setLocal(@NotBlank @Size(min = 3, max = 100) String local) {
        this.local = local;
    }
